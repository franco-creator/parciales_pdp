...
universoAptoParaPendex unUniverso = any (condicionPendex) unUniverso
...
energiaTotalDelUniverso unUniverso = foldr (sumarEnergia) 0 (filtrarPersonajes unUniverso)
...
mente :: Number -> Gema
mente unNumero unaPersona = unaPersona {energia = quitarEnergia unaPersona unNumero}
...
alma :: String -> Gema
alma unaHabilidad unPersonaje = unPersonaje {energia = quitarEnergia unPersonaje 10, habilidades = filtrarHabilidades unaHabilidad (habilidades unPersonaje)}
...
espacio :: String -> Gema
espacio unPlaneta unPersonaje = unPersonaje {energia = quitarEnergia unPersonaje 20, planeta = unPlaneta}
...
-- aca ver esto
poder :: Gema
poder unPersonaje = unPersonaje {energia = 0, habilidades = devolverHabilidades unPersonaje}
...
tiempo :: Gema
tiempo unPersonaje = unPersonaje {edad = edadElTiempo unPersonaje, energia = quitarEnergia unPersonaje 50}

-- tiempo :: Personaje -> Personaje
-- tiempo unPersonaje = Personaje (edadElTiempo unPersonaje) (quitarEnergia unPersonaje 50) (habilidades unPersonaje) (nombre unPersonaje) (planeta unPersonaje)
